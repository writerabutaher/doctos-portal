        ...
        <>
            <div className="bg-white py-6 sm:py-8 lg:py-12">
                <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
                    ...
                    <form onSubmit={handleSubmit(handleRegister)} className="max-w-lg border rounded-lg mx-auto">
                        <div className="flex flex-col gap-4 p-4 md:p-8">
                            ...
                            <div>
                                ...
                                <input {...register("name", {
                                    ...
                                    name="name" className="w-full bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                            ...
                            <div>
                                ...
                                })} name="password" className="w-full bg-gray-50 text-gray-800 border focus:ring ring-indigo-300 rounded outline-none transition duration-100 px-3 py-2" />
                            ...
                            <button type='submit' className="flex justify-center items-center bg-white hover:bg-gray-100 active:bg-gray-200 border border-gray-300 focus-visible:ring ring-gray-300 text-gray-800 text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 gap-2 px-8 py-3">
                            ...
                            <p className="text-center bg-white text-gray-400 text-sm px-4">
                                Already have an account?
                                <Link to='/login' className="underline mx-2 text-primary">Login</Link>
                            </p>
